            ...
            <div className="how-it-works">
                <div className="how-it-works-text-container">
                    ...
                    <ul className="steps-container">
                        ...
                        <li className="body-1">Search for product category (ex. DSLR cameras)</li>
                        <li><h4 className="how-it-works-h4">2. Set filters & preferences</h4></li>
                        <li className="body-1">Set filters and rank your feature preferences </li>
                        <li><h4 className="how-it-works-h4">3. View recommendations</h4></li>
                        <li className="body-1">See the products we think you’ll like</li>
                        <li><h4 className="how-it-works-h4">4. Compare</h4></li>
                        <li className="body-1">Compare products with the help of the Rich Comparison View</li>
                    </ul>
                </div>
