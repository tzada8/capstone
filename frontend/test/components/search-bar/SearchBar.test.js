...
describe("SearchBar", () => {
    it("renders with initial query value and placeholder", () => {
        ...
        expect(getByPlaceholderText("Search for a product")).toBeInTheDocument();
        expect(getByPlaceholderText("Search for a product")).toHaveValue("initial query");
    });
    ...
    it("calls setQuery when input value changes", () => {
        ...
        fireEvent.change(getByPlaceholderText("Search for a product"), { target: { value: "new query" } });
